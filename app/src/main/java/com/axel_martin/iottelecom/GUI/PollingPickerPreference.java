 ...
 */
public class PollingPickerPreference extends DialogPreference {
    ...
    public PollingPickerPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public PollingPickerPreference(Context context, AttributeSet attrs, int defStyleAttr) {
