 ...
 */
public class TemperaturePickerPreference extends DialogPreference {
    ...
    public TemperaturePickerPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public TemperaturePickerPreference(Context context, AttributeSet attrs, int defStyleAttr) {
